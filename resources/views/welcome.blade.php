...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <title>Gamesconn</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">

        <link href="/css/style.css" rel="stylesheet">
    </head>
<body>
    <header class="p-3 bg-dark" style="background-color: #040A11;">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="#" class="nav-link px-2 link-body-emphasis text-light-emphasis">Library</a></li>
                ...
                <div class="dropdown text-end">
                    <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ auth()->user()->profile_image }}" alt="{{ auth()->user()->name }}" width="32" height="32" class="rounded-circle">
                    </a>
...
<main>
    <img
        src="https://giffiles.alphacoders.com/218/218301.gif"
        class="img-fluid "
        style="background-color: #040A11;"
    />
