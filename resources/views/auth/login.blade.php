        ...
        <div class="col-md-6">
            ...
            <div class="login row justify-content-center ">
                <div class="col-md-6">
                    ...
                    <div class="card mt-5">
                        <div class="login row justify-content-center bg-dark card-body">
                            <div class="card-body bg-dark">
                                <h1 class="h3 mb-3 fw-normal text-center judul">Silahkan Login</h1>
                                ...
                                <div class="text-center mt-3">
                                    <small class="judul2">Belum punya akun? <a href="/register">Registrasi</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
